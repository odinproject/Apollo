...
public class ResearchCode2 
{
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        InputStream is = new BufferedInputStream(new FileInputStream(new File(".\\Midis\\FF8101_Liberi.mid")));
        ...
        MidiFileFormat format = reader.getMidiFileFormat(new BufferedInputStream(new FileInputStream(new File(".\\Midis\\FF8101_Liberi.mid"))));
        ...
        double oldPulses = 0;
        long timeStarted = System.currentTimeMillis()+2000;
