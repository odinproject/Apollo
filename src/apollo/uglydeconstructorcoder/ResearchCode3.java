...
import apollo.midideconstructor.Deconstructor;
import apollo.midideconstructor.DeconstructedPossibility;
...
{
    private static int segmentOffset = CONSTS.OFFSET;
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        InputStream is = new BufferedInputStream(new FileInputStream(new File(".\\Midis\\FF8103.mid")));
        ...
        MidiFileFormat format = reader.getMidiFileFormat(new BufferedInputStream(new FileInputStream(new File(".\\Midis\\FF8103.mid"))));
        ...
        //System.out.println(sequence.deleteTrack(tracks[2]));
        //System.out.println(sequence.deleteTrack(tracks[3]));
        //System.out.println(sequence.deleteTrack(tracks[4]));
        //System.out.println(sequence.deleteTrack(tracks[5]));
        //System.out.println(sequence.deleteTrack(tracks[6]));
        //System.out.println(sequence.deleteTrack(tracks[7]));
        //System.out.println(sequence.deleteTrack(tracks[8]));
        //System.out.println(sequence.deleteTrack(tracks[9]));
        //System.out.println(sequence.deleteTrack(tracks[10]));
        //System.out.println(sequence.deleteTrack(tracks[11]));
        //System.out.println(sequence.deleteTrack(tracks[12]));
        //System.out.println(sequence.deleteTrack(tracks[13]));
        //System.out.println(sequence.deleteTrack(tracks[14]));
        ...
        Deconstructor d = new Deconstructor(samplesPerBeat, beatsPerSegment, endOfSong, segmentOffset);
        ...
        {
            if ((pulses-(segmentOffset*pulsesPerSample))%(ppq*beatsPerSegment) == 0)
            {
