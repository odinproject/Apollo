...
public class ResearchCode 
{
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        InputStream is = new BufferedInputStream(new FileInputStream(new File(".\\Midis\\FF8105_Winner.mid")));

        MidiFileReader reader = new MidiFileReader();
        
        MidiFileFormat format = reader.getMidiFileFormat(new BufferedInputStream(new FileInputStream(new File(".\\Midis\\FF8105_Winner.mid"))));
